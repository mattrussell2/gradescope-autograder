...
% find: \\begin\{bashcodeblock\}
%replace: ```

%find: \\end\{bashcodeblock\}
%replace: ```
...
\begin{itemize}
      \item Files to setup both the \code{.zip} and \code{Docker} methods.
...
the \code{REPO_ROOT/hwname/testset/ref_output/} directory. If you need to debug your setup, run 
\begin{bashcodeblock}
